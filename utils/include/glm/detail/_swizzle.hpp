...
struct _swizzle_base1<2, T, Q, E0, E1, -1, -2, Aligned>
...
struct _swizzle_base1<3, T, Q, E0, E1, E2, -1, Aligned>
...
struct _swizzle_base1<4, T, Q, E0, E1, E2, E3, Aligned>
    : public _swizzle_base0<T, 4> {
  GLM_FUNC_QUALIFIER vec<4, T, Q> operator()() const {
    return vec<4, T, Q>(this->elem(E0), this->elem(E1), this->elem(E2),
                        this->elem(E3));
  }
};
...
struct _swizzle_base2 : public _swizzle_base1<N, T, Q, E0, E1, E2, E3,
...
struct _swizzle_base2<N, T, Q, E0, E1, E2, E3, 1>
    : public _swizzle_base1<N, T, Q, E0, E1, E2, E3,
                            detail::is_aligned<Q>::value> {
  struct Stub {};
...
#define GLM_SWIZZLE_VECTOR_BINARY_OPERATOR_IMPLEMENTATION(OPERAND)             \
  ...
  GLM_FUNC_QUALIFIER vec<N, T, Q> operator OPERAND(                            \
  ...
  GLM_SWIZZLE_TEMPLATE1                                                        \
  GLM_FUNC_QUALIFIER vec<N, T, Q> operator OPERAND(                            \
      const vec<N, T, Q> &a, const GLM_SWIZZLE_TYPE1 &b) {                     \
    return a OPERAND b();                                                      \
  }
...
#define GLM_SWIZZLE_SCALAR_BINARY_OPERATOR_IMPLEMENTATION(OPERAND)             \
  ...
  GLM_SWIZZLE_TEMPLATE1                                                        \
  GLM_FUNC_QUALIFIER vec<N, T, Q> operator OPERAND(                            \
      const T &a, const GLM_SWIZZLE_TYPE1 &b) {                                \
    return a OPERAND b();                                                      \
  }
...
#define GLM_SWIZZLE_FUNCTION_2_ARGS(RETURN_TYPE, FUNCTION)                     \
  ...
  GLM_SWIZZLE_TEMPLATE1                                                        \
  GLM_FUNC_QUALIFIER typename GLM_SWIZZLE_TYPE1::RETURN_TYPE FUNCTION(         \
      const GLM_SWIZZLE_TYPE1 &a, const typename V &b) {                       \
    return FUNCTION(a(), b);                                                   \
  }                                                                            \
  GLM_SWIZZLE_TEMPLATE1                                                        \
  GLM_FUNC_QUALIFIER typename GLM_SWIZZLE_TYPE1::RETURN_TYPE FUNCTION(         \
...
#define GLM_SWIZZLE_FUNCTION_2_ARGS_SCALAR(RETURN_TYPE, FUNCTION)              \
  ...
  GLM_SWIZZLE_TEMPLATE1                                                        \
  GLM_FUNC_QUALIFIER typename GLM_SWIZZLE_TYPE1::RETURN_TYPE FUNCTION(         \
      const GLM_SWIZZLE_TYPE1 &a, const typename S0::vec_type &b,              \
      const T &c) {                                                            \
    return FUNCTION(a(), b, c);                                                \
  }                                                                            \
  GLM_SWIZZLE_TEMPLATE1                                                        \
