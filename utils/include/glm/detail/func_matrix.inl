...
struct compute_matrixCompMult {
  GLM_FUNC_QUALIFIER static mat<C, R, T, Q> call(mat<C, R, T, Q> const &x,
                                                 mat<C, R, T, Q> const &y) {
    mat<C, R, T, Q> Result;
...
struct compute_determinant<4, 4, T, Q, Aligned> {
  GLM_FUNC_QUALIFIER static T call(mat<4, 4, T, Q> const &m) {
    ...
    vec<4, T, Q> DetCof(+(m[1][1] * SubFactor00 - m[1][2] * SubFactor01 +
                          m[1][3] * SubFactor02),
...
struct compute_inverse<4, 4, T, Q, Aligned> {
  GLM_FUNC_QUALIFIER static mat<4, 4, T, Q> call(mat<4, 4, T, Q> const &m) {
    ...
    mat<4, 4, T, Q> Inverse(Inv0 * SignA, Inv1 * SignB, Inv2 * SignA,
                            Inv3 * SignB);

    vec<4, T, Q> Row0(Inverse[0][0], Inverse[1][0], Inverse[2][0],
                      Inverse[3][0]);
...
GLM_FUNC_QUALIFIER mat<C, R, T, Q> matrixCompMult(mat<C, R, T, Q> const &x,
                                                  mat<C, R, T, Q> const &y) {
  ...
  return detail::compute_matrixCompMult<C, R, T, Q,
...
template <length_t C, length_t R, typename T, qualifier Q>
GLM_FUNC_QUALIFIER typename mat<C, R, T, Q>::transpose_type
transpose(mat<C, R, T, Q> const &m) {
  GLM_STATIC_ASSERT(std::numeric_limits<T>::is_iec559 ||
                        GLM_CONFIG_UNRESTRICTED_GENTYPE,
                    "'transpose' only accept floating-point inputs");
  return detail::compute_transpose<C, R, T, Q,
                                   detail::is_aligned<Q>::value>::call(m);
}
...
GLM_FUNC_QUALIFIER T determinant(mat<C, R, T, Q> const &m) {
  ...
  return detail::compute_determinant<C, R, T, Q,
                                     detail::is_aligned<Q>::value>::call(m);
}
...
GLM_FUNC_QUALIFIER mat<C, R, T, Q> inverse(mat<C, R, T, Q> const &m) {
  ...
  return detail::compute_inverse<C, R, T, Q,
                                 detail::is_aligned<Q>::value>::call(m);
}
} // namespace glm
