...
namespace ImGui
{
    ...
    // - If you want to use InputText() with a dynamic string type such as std::string or your own, see common/cpp/imgui_stdlib.h
...
enum ImGuiInputTextFlags_
{
    ...
    ImGuiInputTextFlags_CallbackResize      = 1 << 18,  // Callback on buffer capacity changes request (beyond 'buf_size' parameter value), allowing the string to grow. Notify when the string wants to be resized (for string types which hold a cache of their Size). You will be provided a new BufSize in the callback and NEED to honor it. (see common/cpp/imgui_stdlib.h for an example of using this)
    // [Internal]
